		...
		return (
			<div className="flex flex-column flex-row-l items-center">
				<div id="title-box" className="order-1 order-0-l">
					...
					<p className="lh-copy"><strong>currently:</strong> freelance (aka <a href="mailto:ok@tomhuhges.com" className="link">hire me</a>)</p>
					<p className="lh-copy"><strong>previously:</strong> lead developer and designer at springwise</p>
					<p className="lh-copy"><a href="mailto:ok@tomhuhges.com" className="link">ok@tomhuhges.com</a> ~ <a href="tel:+447725577327" className="link">+44 772 5577 327</a></p>
				</div>
